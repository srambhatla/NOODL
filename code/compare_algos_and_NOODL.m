% Comparing performance of NOODL with other techniques (non-dstributed)
%
% Sirisha Rambhatla, March 2018
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Function: compare_algos_and_NOODL.m
%
...
%  t_a2 = toc;
%
%  XS_arora_red_ol = XS_arora_red_ol;
%  XS_arora_ol = XS_arora_ol;
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 ...
 display(['ODL Sapiro: iter = ', num2str(i), '   ,errA = ', num2str(errA_odl(end)), '   ,errX = ', num2str(errX_odl(end)), ', time = ', num2str(time_odl(end)), ', time coeff = ', num2str(time_odl_coeff(end))])
  ...
  t_ar2 = t_ar_red_coeff/i_ar;
  t_a2 = t_ar_coeff/i_a;


display(['Err Coeff "unbiased" after lasso ',num2str(norm(XS_arora_red_ol - X_new,'fro')/norm(X_new,'fro')),' time coeff',t_ar_red_coeff,'iter',i_ar])
display(['Err Coeff "biased" after lasso ',num2str(norm(XS_arora_ol - X_new,'fro')/norm(X_new,'fro')),' time coeff',t_ar_coeff,'iter coeff',i_a])
